package fr.unice.polytech.si5.al.tfc.tdd.common.cli.framework;
...
public class Shell<T> {
    ...
    private boolean processCommand(String identifier, List<String> args) throws Exception {
        if (!commands.containsKey(identifier)) {
            System.out.println("Unknown command: " + identifier);
            return true;
        }

        Class<? extends Command<T>> command = commands.get(identifier);
        try {
